...
var file_gateWay_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x67, 0x61, 0x74, 0x65, 0x57, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x09, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x43, 0x6f, 0x64, 0x65, 0x1a, 0x1c, 0x67, 0x6f, 0x6f, 0x67,
	...
	,
...
var file_gateWay_proto_goTypes = []interface{}{
	(*StringMessage)(nil), // 0: protoCode.StringMessage
}
var file_gateWay_proto_depIdxs = []int32{
	0, // 0: protoCode.RestService.Get:input_type -> protoCode.StringMessage
	0, // 1: protoCode.RestService.Post:input_type -> protoCode.StringMessage
	0, // 2: protoCode.RestService.Get:output_type -> protoCode.StringMessage
	0, // 3: protoCode.RestService.Post:output_type -> protoCode.StringMessage
...
func (c *restServiceClient) Get(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/protoCode.RestService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restServiceClient) Post(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/protoCode.RestService/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RestService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoCode.RestService/Get",
	}
...
func _RestService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoCode.RestService/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _RestService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protoCode.RestService",
